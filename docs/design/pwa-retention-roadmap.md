...
| Query/index cold-load performance | Issue #48 analytics-index workstream | Another index proposal |
...
| Offline selected slices and opportunistic refresh | Dedicated medium follow-up | “Cache everything” |
| Notification/platform decision and Atom feed | Dedicated medium follow-up | Push implementation |
| Retained generations, historical summaries, migrations | Dedicated large follow-up | Inferring history from latest rows |
| Source/company coverage governance | Dedicated data-quality follow-up | One issue per unmeasured employer |
