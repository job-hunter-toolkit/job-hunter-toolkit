...
$ node web/test/config.mjs && node web/test/snapshot.mjs && node web/test/readiness.mjs && node web/test/store.mjs && node web/test/engine-client.mjs && node web/test/sw.mjs && node web/test/rollup.mjs && node web/test/freshness.mjs && node web/test/card.mjs && node web/test/webmcp.mjs
